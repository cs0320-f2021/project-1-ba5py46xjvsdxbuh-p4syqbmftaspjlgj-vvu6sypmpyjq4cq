...
//    tree.insertNode(new Node(1, 1, 1, 1, "Leo"));
//    Assert.assertEquals("ID: 1", tree.toString());
//  }
//  @Test
//  public void testInsertInCorrectOrder(){
//    KDTree tree = new KDTree();
//    tree.insertNode(new Node(1, 10, 10, 10, "Leo"));
//    tree.insertNode(new Node(2, 0, 10, 10, "Leo"));
//    tree.insertNode(new Node(3, 15, 10, 10, "Leo"));
...
//    KDTree tree = new KDTree();
//    tree.insertNode(new Node(1, 10, 10, 10, "Leo"));
//    tree.insertNode(new Node(2, 15, 10, 10, "Leo"));
//    tree.insertNode(new Node(3, 20, 5, 10, "Leo"));
//    tree.insertNode(new Node(4, 20, 15, 10, "Leo"));
...
//    KDTree tree = new KDTree();
//    tree.insertNode(new Node(1, 10, 10, 10, "Leo"));
//    tree.insertNode(new Node(2, 5, 10, 10, "Leo"));
//    tree.insertNode(new Node(3, 5, 5, 10, "Leo"));
//    tree.insertNode(new Node(4, 5, 15, 10, "Leo"));
//    Assert.assertEquals("ID: 1, ID: 2, ID: 3, ID: 4", tree.toString());
//  }
//  @Test
...
//    KDTree tree = new KDTree();
//    tree.insertNode(new Node(1, 10, 10, 10, "Leo"));
//    tree.insertNode(new Node(2, 5, 5, 5, "Leo"));
//    tree.insertNode(new Node(3, 15, 15, 15, "Leo"));
//    tree.insertNode(new Node(4, 3, 3, 3, "Leo"));
//    tree.insertNode(new Node(5, 8, 8, 8, "Leo"));
//    tree.insertNode(new Node(6, 13, 13, 13, "Leo"));
//    tree.insertNode(new Node(7, 18, 18, 18, "Leo"));
